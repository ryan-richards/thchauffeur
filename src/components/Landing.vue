...
<style>
  ...
  .card-under{
     backdrop-filter: blur(17px) saturate(169%);
    -webkit-backdrop-filter: blur(17px) saturate(169%);
...
.button {
       backdrop-filter: blur(0px) saturate(169%);
    -webkit-backdrop-filter: blur(17px) saturate(169%);
    background-color: rgba(255, 255, 255, 0);
    border-radius: 12px;
    border: 1px solid rgba(23, 61, 119, 0.3);
}
